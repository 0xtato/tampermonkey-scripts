// ==UserScript==
// @name     Pokémon BestBuy-RefreshNoBot
...
((_)_((_)(_)) (_(_())  ((_)_ _ ((_)_ ((_) ((_)_  ((_)(_(_())
 ...
 const ITEM_KEYWORD= "Pokémon"; // NO SPACES IN KEYWORD - ONLY ONE WORD
 const CREDITCARD_CVV = "111"; // BOT will run without changing this value.
